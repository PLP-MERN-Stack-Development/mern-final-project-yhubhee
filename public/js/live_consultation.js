var AppProcess = (function () {
        ...
        try {
            ...
            if (vstream && vstream.getVideoTracks().length > 0) {
                ...
                if (videoCamTrack) {
                    ...
                    console.log("Live video feed is being sent:", videoCamTrack);
                    // alert("Video Stream Sent")
    ...
    // Add this after your other event handlers in AppProcess
    $(document).on("click", "#flipCameraBtn", async function () {
        // Toggle facing mode
        ...
        try {
            ...
            // Replace the video track in your local video element
            if (local_div) {
                local_div.srcObject = new MediaStream([newVideoTrack]);
            }

            // Replace the video track in your WebRTC connection
            updateMediaSenders(newVideoTrack, rtp_vid_senders);

            // Update the global reference
            videoCamTrack = newVideoTrack;
